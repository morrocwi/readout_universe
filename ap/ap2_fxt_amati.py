...
- G7 (readout-vs-readout): the refutation half CHECKS OUT structurally --
  off-axis deboosting moves a burst ALONG the Amati locus (extended-jet
  scaling) or ABOVE it (compact scaling); BELOW is unreachable. Verified here.
...
def test_below_locus_unreachable_by_viewing_angle():
    ...
    the deboosted point never falls below the locus => low-E_p-at-high-E_iso
    FXTs cannot be made by viewing angle alone. This independently confirms
    the paper's refutation direction."""
