...
echo "######## 4/5  pytest suite (ap/, via lens/) ########"
python3 -m pytest -q

echo "######## 5/5  gate-typing law (docs/GATE_TYPING_LAW.md) ########"
python3 scripts/check_gate_typing.py gates/GATE_DECLARATIONS.txt

echo "✅ ALL CI CHECKS PASSED — LTP battery, UPL_Sorites, evidence/*.v chain, pytest, gate-typing law all green."
