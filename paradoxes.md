...
(`formal/InfoLiarNoAnchoredResolution_attempt.v` (solver arc (private))),
...
`formal/InfoAgencySelfReadout_attempt.v` (solver arc (private)) proves
...
`docs/root/AGENCY_VS_AGENCY_LIKE.md` (solver arc (private)):
...
[domain card: formal/InfoAgencySelfReadout_attempt.v (solver arc (private));
docs/root/AGENCY_VS_AGENCY_LIKE.md (solver arc (private));
...
- [`philosophy.md`](philosophy.md) and [`logic.md`](logic.md) — the core
  ...
  into either.
- `formal/InfoAgencySelfReadout_attempt.v` (solver arc (private)) and
  `docs/root/AGENCY_VS_AGENCY_LIKE.md` (solver arc (private)) — the
