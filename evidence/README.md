...
|------|------------------------|---------------|----------------|
| `RD.v` | `solver-arc-private/formal/RD.v` | 2026-07-19 | The Information-DNA object stratum: RD1–RD9 as Inductive D + theorems (RD3/RD4), commutative semiring, total order, semiring+order isomorphism D ≅ ℕ, equational transfer RD↔PA (deep-embedded term language) |
| `URCF_RD_All.v` | `solver-arc-private/formal/URCF_RD_All.v` | 2026-07-19 | The consolidated URCF/RD verified foundations (≈678 Theorem/Lemma declarations) |
